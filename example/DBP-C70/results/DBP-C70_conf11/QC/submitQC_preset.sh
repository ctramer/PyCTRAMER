...
#RUNDIR=/gpfsnyu/xspace/projects/PCT-example/DBP-C70/results/DBP-C70_conf11/QC/${WORKDIR}/${system}${structure}_${functional}_${n_states}states_w${w}
...
N! OMEGA                 ${w}             # If known! 157 for linear and 154 for bent. For now use 157 for all
TUN! OMEGA               0               # Enter 1 for tuning the omega for each geometry. Not implemented yet!!!
EOF
