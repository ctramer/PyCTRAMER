...
total_traj=1
continue_from=0
inpdir=/gpfsnyu/xspace/projects/PCT-example/triad/results/triad_conf3/MD/
GIVEN_STRUC=conf3
DEP=9697755,9697756,9697757
state_list='GR LE CT1 CT2 '
for structure in $GIVEN_STRUC #(( structure = ${START}; structure <= ${END}; structure++))
do

PROJECT_DIR=/gpfsnyu/xspace/projects/PCT-example/triad/results/triad_conf3/MD/
DATA_DIR=/gpfsnyu/xspace/projects/PCT-example/triad/results/triad_conf3/QC/
...
module use /gpfsnyu/xspace/users/zl3289/modules
