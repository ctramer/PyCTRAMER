...
WORKDIR=/gpfsnyu/xspace/users/zl3289/topics/ptr/PyCTRAMER_wf1/example/triad/results/triad_conf3/QC/ 
SRCDIR=/gpfsnyu/xspace/users/zl3289/topics/ptr/PyCTRAMER_wf1/template/triad
...
#RUNDIR=/gpfsnyu/xspace/users/zl3289/topics/ptr/PyCTRAMER_wf1/example/triad/results/triad_conf3/QC/${WORKDIR}/${system}${structure}_${functional}_${n_states}states_w${w}
RUNDIR=/gpfsnyu/xspace/users/zl3289/topics/ptr/PyCTRAMER_wf1/example/triad/results/triad_conf3/QC/
mkdir -p ${RUNDIR}
